...
public class PopupHandle_ToCloseChildWindows extends StaticVariables{
  ...
  public void f() throws Exception{
	...
	cfn.openTheURL("https://www.naukri.com/");
	//To close the Child popups
	cfn.popupHandleToCloseTheChildWindow();
	
  }
  @AfterMethod
  public void afterMethod() throws Exception {
	  
	  cfn.takeScreenshot("PopupHandle_ToCloseChildWindows");
  }
