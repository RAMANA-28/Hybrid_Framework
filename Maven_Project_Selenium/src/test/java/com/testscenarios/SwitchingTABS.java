...
public class SwitchingTABS extends StaticVariables{
  ...
  public void f() throws Exception{
	...
	cfn.implicitWait(10);
	//click on click to open newwindow button on Parent Page
	//cfn.clickByAnyLocator(By.xpath("//button[contains(text(),'Click to open new Window')]"));
  ...
  public void afterMethod() throws Exception {
	  ...
	  cfn.takeScreenshot("SwitchingTABS");
  }
